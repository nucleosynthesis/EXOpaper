{
  ...
  hggStyle->SetTitleSize(0.04, "XY");
  hggStyle->SetLabelSize(0.035, "Z");
  hggStyle->SetLabelSize(0.04, "XY");
  hggStyle->SetLabelFont(42);
  hggStyle->SetTitleFont(42, "Z");
  hggStyle->SetNdivisions(111,"Z");
  //hggStyle->SetNumberContours(999);
  hggStyle->cd();
}
